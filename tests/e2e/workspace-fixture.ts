...
export async function workspaceFixture(page: Page, local = false) {
  ...
  const config = loadConfig({ HERMES_DASHBOARD_URL: upstream.origin, PUBLIC_ORIGIN: 'http://127.0.0.1:1', WORKSPACE_ROOTS: project, GIT_ENABLED: 'true',
